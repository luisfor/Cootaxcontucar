...
class EpsController extends Controller
{
    ...
    public function find(Route $route){
        $this->eps = Eps::find($route->getParameter('eps'));
    ...
    public function index(Request $request)
    {
        ...
        $eps = Eps::all();
        /*if($request->ajax()){
            return response()->json(view('config.eps.eps',compact('eps'))->render());
        }*/
        return view('config.eps.index',compact('eps'));
    }
    ...
    {
        $this->eps->delete();
        Session::flash('message','eps Eliminado Correctamente');
